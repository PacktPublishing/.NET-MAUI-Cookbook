    ...
    RoleManager<IdentityRole> roleManager) =>
{
    ...
    JsonNode tokenData = JsonSerializer.Deserialize<JsonNode>(responseText);

    string token = tokenData["accessToken"].GetValue<string>();
    string refreshToken = tokenData["refreshToken"].GetValue<string>();
    int expiresIn = tokenData["expiresIn"].GetValue<int>();
